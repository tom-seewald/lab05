...
/**
 * Convert's the given image to grayscale using the averaging method.
 */
void imageToGrayScaleAverage(Pixel **image, int height, int width);

/**
 * Convert's the given image to grayscale using the lightness method.
 */
void imageToGrayScaleLightness(Pixel **image, int height, int width);

/**
 * Convert's the given image to grayscale using the luminosity method.
 */
